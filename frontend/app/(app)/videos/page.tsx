...
function SubjectIcon({ _icon, icon }: { _icon?: Playlist["icon"]; icon?: Playlist["icon"] }) {
  void _icon;
  void icon;
  return (
...
export default function VideosPage() {
  ...
  return (
    <div className="videos-page">
      ...
      <header className="videos-header" data-ui-chrome="header">
        ...
        <section className="playlist-list" aria-label="Video playlists">
          {visiblePlaylists.length > 0 ? (
            ...
            <div className="empty-state">
              <PlayCircle size={44} strokeWidth={1.75} />
      ...
      <style>{`
        /* ==========================================================================
           VIDEOS PAGE MOBILE SHELL & DESIGN.MD RULES
           ========================================================================== */

        .videos-page {
          --video-page-bg: var(--light-canvas, #f6f7f9);
          --video-page-fg: var(--light-text, #1c2533);
          --video-title-fg: var(--light-text, #1c2533);
          --video-muted-fg: var(--light-text-secondary, #647084);
          --video-more-fg: var(--light-text-secondary, #647084);
          --video-empty-fg: var(--light-text-secondary, #647084);
          --video-header-bg: rgba(255, 255, 255, 0.88);
          --video-header-border: var(--light-border, #e3e6eb);
          --video-chip-bg: var(--light-surface-muted, #f0f2f5);
          --video-chip-fg: var(--light-text-secondary, #647084);
          --video-chip-border: var(--light-border, #e3e6eb);
          --video-chip-active-bg: var(--light-accent, #2563eb);
          --video-chip-active-fg: #ffffff;
          --video-chip-active-border: var(--light-accent, #2563eb);
          --video-card-bg: var(--light-surface, #ffffff);
          --video-card-border: var(--light-border, #e3e6eb);
        ...
        .videos-page.dark {
          --video-page-bg: var(--dark-canvas, #000000);
          --video-page-fg: var(--dark-text, #f0f2f5);
          --video-title-fg: var(--dark-text, #f0f2f5);
          ...
          --video-chip-active-bg: var(--dark-accent, #85aaff);
          --video-chip-active-fg: var(--dark-canvas, #17191d);
          --video-chip-active-border: var(--dark-accent, #85aaff);
          --video-card-bg: var(--dark-surface, #22252b);
          --video-card-border: var(--dark-border, #363b44);
        }

        /* --- Rule 1: Header Safe Area & Dynamic Inset --- */
        .videos-header {
          flex-shrink: 0;
          position: sticky;
          top: 0;
        ...
        .videos-content {
          ...
          padding-bottom: calc(var(--app-bottom-nav-height, 94px) + var(--safe-bottom) + 16px);
        }
