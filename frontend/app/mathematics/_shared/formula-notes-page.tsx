    ...
    <main className="formula-notes-page">
      ...
      <style jsx>{`
        ...
        .fn-card-icon-wrap {
          ...
          justify-content: center;
          flex-shrink: 0;
          color: var(--pdf-icon-color, #ffffff);
        ...
        :global(html.theme-light) .formula-notes-page {
          ...
          --pdf-icon-color: #000000;
        }

        :global(body.theme-light) .fn-card-icon-wrap,
        :global(html.theme-light) .fn-card-icon-wrap {
          color: #000000;
        }
