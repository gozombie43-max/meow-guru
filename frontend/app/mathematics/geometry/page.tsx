    ...
    <main className="algebra-page">
      ...
      <style>{`
        ...
        .promo-banner {
          ...
          border-radius: 24px;
          padding: 22px 18px;
          background: linear-gradient(135deg, #5f78ff 0%, #36c2ff 100%);
          box-shadow: 0 14px 32px rgba(95, 120, 255, 0.24);
          display: grid;
        ...
        .feature-card {
          ...
          overflow: hidden;
          min-height: 120px;
          box-shadow: 0 14px 22px rgba(31, 50, 84, 0.16);
          transition: transform 180ms ease, box-shadow 180ms ease;
        }

        .feature-card:hover {
          transform: translateY(-2px);
          box-shadow: 0 18px 26px rgba(31, 50, 84, 0.23);
        }
