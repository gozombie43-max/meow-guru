...
const buildFeatureCards = (slug: string): FeatureCardData[] => [
  ...
  {
    title: "Topic Mix",
    href: `/general-awareness/${slug}/quiz?mode=easy`,
  ...
  {
    title: "Tier 2",
    href: `/general-awareness/${slug}/quiz?mode=hard`,
  ...
  return (
    <main className="ga-topic-page">
      <div className="ga-container">
        ...
        <Link
          href={`/general-awareness/${slug}/formula-notes`}
      ...
      <style>{`
        ...
        .promo-banner {
          ...
          border-radius: 24px;
          padding: 22px 18px;
          background: linear-gradient(135deg, #61d08a 0%, #3fbf87 60%, #2bb6ad 100%);
          box-shadow: 0 14px 32px rgba(47, 185, 167, 0.25);
          display: grid;
        ...
        body.theme-dark .ga-topic-page::before,
        body.theme-dark .ga-topic-page::after {
          content: "";
          position: fixed;
          border-radius: 999px;
          pointer-events: none;
        ...
        body.theme-dark .promo-banner {
          ...
          background: linear-gradient(135deg, rgba(47, 185, 167, 0.2) 0%, rgba(63, 191, 135, 0.2) 100%) !important;
