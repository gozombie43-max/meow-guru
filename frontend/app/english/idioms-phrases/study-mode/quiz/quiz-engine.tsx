...
const DEMO_CARD: StudyModeCard = {
  ...
  synonyms: [
    { word: "Losing that job turned out to be a blessing in disguise because it led me to my current career.", translation: "" }
  ],
  antonyms: [],
};
        ...
        <aside className="macos-sidebar">
          ...
          >
            <button
              type="button"
              className="light red"
              onClick={() => router.push("/english/idioms-phrases/study-mode")}
          ...
          <div className="dictionary-body-scroll">
            ...
            <section className="apple-tables-grid">
              {(viewMode === "all" || viewMode === "synonyms") && (
                <div className="ns-table-container">
                  <div className="table-header">
                    <span className="table-title">EXAMPLES</span>
              ...
              {(viewMode === "all" || viewMode === "antonyms") && (
                <div className="ns-table-container">
                  <div className="table-header">
                    <span className="table-title">RELATED</span>
            ...
            <section className="mobile-suite">
              <div className="mobile-seg-control">
                ...
                >
                  Examples ({activeCard.synonyms.length})
                </button>
                <button
                  type="button"
                ...
                >
                  Related ({activeCard.antonyms.length})
                </button>
              </div>
