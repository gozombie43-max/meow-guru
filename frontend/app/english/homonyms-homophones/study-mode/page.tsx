...
export default function HomonymsStudyModePage() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if ((e.key === "Enter") && e.target === document.body) {
        router.push("/english/homonyms-homophones/study-mode/quiz");
      }
    };
      ...
      <header className="fullscreen-topbar">
        ...
        >
          ...
          <button
            ...
            onClick={() => router.push("/english/homonyms-homophones/study-mode/quiz")}
      ...
      <section className="launcher-body">
        <div className="centerpiece-content">
          ...
          <div className="title-group">
            ...
            <h1 className="hero-title">Homonyms &amp; Homophones</h1>
