...
type QuizQuestionRecord = QuizQuestion & {
  quizName?: string;
  source?: string;
  quizId?: string;
};
...
let QUIZ_THEME_STORAGE_KEY = "quiz-theme"; // set dynamically by component
let QUIZ_CSS_CLASS = "quiz"; // set dynamically by component
let FORMULA_MODE_LABEL = "Pattern Practice"; // set dynamically by component
...
function ensureUniqueQuestionIds(questions: QuizQuestionRecord[]): QuizQuestionRecord[] {
...
type ClassificationGroup = import("@/components/quiz-engine/types").ClassificationCategory & {
  concepts: string[];
};
...
function QuizThemeStyles({ cssClassName }: { cssClassName: string }) {
  return (
    <style jsx global>{`
      .${cssClassName} {
...
export default function QuizEngine({
  ...
  QUIZ_THEME_STORAGE_KEY = `${subjectConfig.subjectId}-quiz-theme`;
  QUIZ_CSS_CLASS = subjectConfig.cssClassName;
  FORMULA_MODE_LABEL = subjectConfig.formulaModeLabel ?? "Pattern Practice";
